...
//Creamos variable para seleccionar el span cuyo id es createdBy
let span = document.querySelector('#createdBy');

//Modificamos el valor de la variable con innerHTML
span.innerHTML = 'Aplicación creada por: Antonio Silva';
...
// Ayuda: usar 'this' en el constructor
  ...
  //Creamos clase con dos propiedades, que recibe un parámetro en su constructor 
  class ToDo {
...
function buildToDos(toDos) {
  // Tu código acá:
let arrayMap = toDos.map(function(elemento, index){
