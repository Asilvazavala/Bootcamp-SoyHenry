 ...
 */
  ...
  promisifiedReadFile('poem-one/stanza-01.txt') 
    .then(function(stanza01) {
      console.log(stanza01);
      blue(stanza01);
    })
  }
 ...
 */
  ...
  .then(function(stanza02) {
    console.log(stanza02);
    blue(stanza02);
  })
  promisifiedReadFile('poem-one/stanza-03.txt')
  .then(function(stanza03) {
    console.log(stanza03);
    blue(stanza03);
  })
...
/*   readFile('poem-one/wrong-file-name.txt', function (err, stanza4) {
  ...
  promisifiedReadFile('poem-one/stanza-04.txt')
    .then(function(stanza04) {
      console.log(stanza04);
      blue(stanza04);
    }, function(err) {
      console.log(err);
      magenta(err);
