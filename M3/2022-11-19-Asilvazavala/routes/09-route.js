...
/* ⚠️ No modificar nada arriba de esta línea ⚠️
  ...
  📌 Responder con un objeto con una propiedad "message" que se igual al string "Coche actualizado 
  correctamente".
  ...
  2) Recibirás los argumentos necesario para ejecutar esa función updateCar mediante la propiedad "body" de 
  *req*.
